...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Car tracking system">
    ...
    $cs->registerScriptFile($baseUrl . '/libraries/DataTables-1.9.4/media/js/jquery.dataTables.min.js');
    $cs->registerScriptFile($baseUrl . '/libraries/jquery-chosen-0.9.8/chosen.jquery.min.js');
  ...
  <?php  
    ...
    $cs->registerCssFile($baseUrl . '/libraries/DataTables-1.9.4/media/css/jquery.dataTables.css');
