...
class GpsDeviceController extends Controller
{
	...
	public function actionIndex()
	{
		$rsGpsDevices = Yii::app()->db->createCommand()
			...
			->from('gpsDevice')
			->queryAll();
		// print_r($gpsDeviceArray); die();
		$this->render('index',array(
			'gpsDeviceArray' => $rsGpsDevices,
		));
	}
	 ...
	 * @return GpsDevice the loaded model
	 ...
	 * @param GpsDevice $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gps-device-form')
		{
