...
class CompaniesController extends Controller
{
	...
	public function actionIndex()
	{
		...
		foreach ($rsCompanies as $companyKey => $companies) {
			$companiesArray[$companyKey]['id'] = $companies['id'];
			$companiesArray[$companyKey]['name'] = $companies['name'];
			$companiesArray[$companyKey]['email'] = $companies['email'];
			$companiesArray[$companyKey]['address'] = $companies['address'];
		}
