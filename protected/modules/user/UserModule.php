...
Yii::setPathOfAlias('YumThemes' , dirname(Yii::app()->request->scriptFile).'/themes/abound/');
...
class UserModule extends CWebModule {
	...
	public $baseLayout = 'YumThemes.views.layouts.main';
	public $layout = 'YumThemes.views.layouts.yum';
	...
	public $loginLayout = 'YumThemes.views.layouts.column1';
	public $adminLayout = 'YumThemes.views.layouts.yum';
