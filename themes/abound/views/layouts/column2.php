	...
	<div class="span3">
		...
		// if($superUser) {
			$this->widget('zii.widgets.CMenu', array(
			  	'encodeLabel' => false,
			  	'items' => array(
					array('label'=>'<i class="icon icon-wrench"></i>  Car Management', 'itemOptions'=>array('class'=>'ui-widget-header ui-corner-top')),
			  		array('label' => 'Devices', 'url'=>array('//gpsDevice/index')),
			  		array('label' => 'Cars', 'url'=>array('//cars/index')),
			  		array('label' => 'Companies', 'url'=>array('//companies/index')),
